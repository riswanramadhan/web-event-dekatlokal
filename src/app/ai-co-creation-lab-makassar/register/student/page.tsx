  ...
  return (
    <>
      <EventPageHero
        ...
        title="Daftar sebagai mahasiswa problem solver."
        description="Ceritakan kemampuan, pengalaman menggunakan AI, perangkat yang tersedia, dan peran yang paling sesuai untuk berkolaborasi dengan UMKM."
          ...
          >
            <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-card">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-600">
                mahasiswa dalam empat tim lintas kemampuan.
              </p>
            </div>
            ...
            <div className="rounded-[1.75rem] border border-brand-100 bg-brand-50 p-6">
              ...
              <p className="mt-2 text-xs leading-6 text-slate-600">
                Penyelenggara akan meninjau kecocokan peran, komposisi tim,
                perangkat, dan komitmen hadir. Hasil seleksi disampaikan
                melalui kontak yang didaftarkan.
              </p>
            </div>
          </aside>
        </div>
